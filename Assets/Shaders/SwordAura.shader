    ...
    SubShader {
        ...
        Pass {
            ...
            v2f vert (appdata v) {
                ...
                // 1. Phóng to bề ngang (X, Y) từ tâm hình học (Dành riêng cho Lưỡi kiếm)
                localPos -= _BoundsCenter.xyz;
                ...
                // Áp dụng thông số _ZStretch từ Inspector để người dùng tự tinh chỉnh!
